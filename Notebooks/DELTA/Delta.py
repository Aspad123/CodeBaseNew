...
# MAGIC )
# MAGIC USING DELTA
# MAGIC LOCATION 's3://aspad-22082024-test/test_table1'
...
display(spark.read.parquet("s3://aspad-22082024-test/json/part-00000-bf76f5c1-8647-4f7e-9a4d-1b92b4d42e36-c000.snappy.parquet"))

# COMMAND ----------

# MAGIC %sql
# MAGIC INSERT INTO lakehouse_dev.default.test_table1 VALUES (2, 'Aspad', 29, 'Maharashtra', 'Blr', 10000.0)
...
# MAGIC %sql
# MAGIC INSERT INTO lakehouse_dev.default.test_table1 VALUES (3, 'Aspad', 29, 'Rajahmundry', 'Blr', 10000.0);
# MAGIC INSERT INTO lakehouse_dev.default.test_table1 VALUES (4, 'Aspad', 29, 'Maharashtra', 'Blr', 10000.0);
# MAGIC INSERT INTO lakehouse_dev.default.test_table1 VALUES (5, 'Aspad', 29, 'Maharashtra', 'Blr', 10000.0);
# MAGIC INSERT INTO lakehouse_dev.default.test_table1 VALUES (6, 'Aspad', 29, 'Maharashtra', 'Blr', 10000.0);
# MAGIC INSERT INTO lakehouse_dev.default.test_table1 VALUES (7, 'Aspad', 29, 'Maharashtra', 'Blr', 10000.0);
# MAGIC INSERT INTO lakehouse_dev.default.test_table1 VALUES (8, 'Aspad', 29, 'Maharashtra', 'Blr', 10000.0);
# MAGIC INSERT INTO lakehouse_dev.default.test_table1 VALUES (9, 'Aspad', 29, 'Maharashtra', 'Blr', 10000.0);
# MAGIC INSERT INTO lakehouse_dev.default.test_table1 VALUES (10, 'Aspad', 29, 'Maharashtra', 'Blr', 10000.0);
# MAGIC INSERT INTO lakehouse_dev.default.test_table1 VALUES (11, 'Aspad', 29, 'Maharashtra', 'Blr', 10000.0);
# MAGIC

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM lakehouse_dev.default.test_table1 VERSION AS OF 14
...
# MAGIC %run Workspace/Users/aspadsamantaray@gmail.com/CodeBaseNew/Notebooks/common_utils
# MAGIC
...
source_sinks = [
    {
        "source":{
            "path": "s3://aspad-22082024-test/dataset/parquet/allergies",
            "type": "file",
            "format": "parquet"
        },
        "sink":{
            "path": "s3://aspad-22082024-test/delta/allergies",
            "mode": "overwrite",
    ...
    {
        "source":{
            "path": "s3://aspad-22082024-test/dataset/parquet/claims_transactions",
            "type": "file",
            "format": "parquet"
        },
        "sink":{
            "path": "s3://aspad-22082024-test/delta/claims_transactions",
            "mode": "overwrite",
            "database": "lakehouse_dev.health_care",
    ...
    {
        "source":{
            "path": "s3://aspad-22082024-test/dataset/parquet/claims",
            "type": "file",
            "format": "parquet"
        },
        "sink":{
            "path": "s3://aspad-22082024-test/delta/claims",
            "mode": "overwrite",
            "database": "lakehouse_dev.health_care",
            "table": "delta_claims",
            "format": "delta"
    ...
    {
        "source":{
            "path": "s3://aspad-22082024-test/dataset/parquet/patients",
            "type": "file",
            "format": "parquet"
        },
        "sink":{
            "path": "s3://aspad-22082024-test/delta/patients",
            "mode": "overwrite",
            "database": "lakehouse_dev.health_care",
    ...
    {
        "source":{
            "path": "s3://aspad-22082024-test/dataset/parquet/payers",
            "type": "file",
            "format": "parquet"
        },
        "sink":{
            "path": "s3://aspad-22082024-test/delta/payers",
            "mode": "overwrite",
            "database": "lakehouse_dev.health_care",
            "table": "delta_payers",
            "format": "delta"
