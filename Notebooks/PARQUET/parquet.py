...
source_bucket_name = 'aspad-22082024-test'
destination_bucket_name = 'aspad-22082024-test'
...
table_name = f"{catalog_name}.{schema_name}.claims_transactions"

# COMMAND ----------

read_path = f"s3://{source_bucket_name}/dataset/claims_transactions"
...
sql_query = f"""
    ...
    FROM {database_name}.claims_transactions
"""
...
table_name = f"{database_name}.claims_transactions"
